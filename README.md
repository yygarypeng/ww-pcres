...
```
cd existing_repo
git remote add origin https://gitlab.cern.ch/atlas-physics/higp/nresmultileptons/hww/qe/lvlv/ml-models/hww_pcres_regressor.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.cern.ch/atlas-physics/higp/nresmultileptons/hww/qe/lvlv/ml-models/hww_pcres_regressor/-/settings/integrations)
