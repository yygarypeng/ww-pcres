...
def neural_input_features_numpy(features: np.ndarray) -> np.ndarray:
    ...
    return np.concatenate([
        features[:, :3], np.log1p(features[:, 3:4]),
        features[:, 4:7], np.log1p(features[:, 7:8]),
        features[:, 8:11], np.log1p(features[:, 11:12]),
...
def neural_input_features_torch(features: torch.Tensor) -> torch.Tensor:
    ...
    return torch.cat([
        features[:, :3], torch.log1p(features[:, 3:4]),
        features[:, 4:7], torch.log1p(features[:, 7:8]),
        features[:, 8:11], torch.log1p(features[:, 11:12]),
